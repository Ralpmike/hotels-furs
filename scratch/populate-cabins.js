...
const supabaseUrl = 'https://nhbdvybnqsksvsojnnmi.supabase.co';
const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY || 'sb_publishable_6MVOITaAJ1dQPL5VO4BFxg_o-WboytX';
...
async function run() {
  ...
  if (error) {
    console.error("Error inserting cabins:", error);
  } else {
    console.log("Successfully inserted cabins:", data);
  }
}
